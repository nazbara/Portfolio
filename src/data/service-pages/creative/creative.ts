...
/** PLACEHOLDER CONTENT — the Creative group landing page (/services/creative). */
export const creativePage: ServicePage = {
  slug: 'creative',
  title: 'Creative',
  hero: { label: 'Services', lines: ['CREATIVE', 'BUILT AROUND', 'YOUR GOALS.'] },
  approach: {
    label: 'Approach',
    paragraphs: [
      'Placeholder: how we approach creative. We start with your goals, agree what good looks like and only then decide what to make.',
  ...
  faq: [
    { q: 'Placeholder: what is included in creative?', a: 'Placeholder answer. One or two sentences that answer the question plainly.' },
