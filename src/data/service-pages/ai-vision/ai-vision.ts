...
/** PLACEHOLDER CONTENT — the AI Vision group landing page (/services/ai). */
export const aiVisionPage: ServicePage = {
  slug: 'ai',
  title: 'AI Vision',
  hero: { label: 'Services', lines: ['AI VISION', 'BUILT AROUND', 'YOUR GOALS.'] },
  approach: {
    label: 'Approach',
    paragraphs: [
      'Placeholder: how we approach ai vision. We start with your goals, agree what good looks like and only then decide what to make.',
  ...
  faq: [
    { q: 'Placeholder: what is included in ai vision?', a: 'Placeholder answer. One or two sentences that answer the question plainly.' },
