...
/** PLACEHOLDER CONTENT — the Strategy group landing page (/services/strategy). */
export const strategyPage: ServicePage = {
  slug: 'strategy',
  title: 'Strategy',
  hero: { label: 'Services', lines: ['STRATEGY', 'BUILT AROUND', 'YOUR GOALS.'] },
  approach: {
    label: 'Approach',
    paragraphs: [
      'Placeholder: how we approach strategy. We start with your goals, agree what good looks like and only then decide what to make.',
  ...
  faq: [
    { q: 'Placeholder: what is included in strategy?', a: 'Placeholder answer. One or two sentences that answer the question plainly.' },
