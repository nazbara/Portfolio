...
/** PLACEHOLDER CONTENT — the Digital group landing page (/services/digital). */
export const digitalPage: ServicePage = {
  slug: 'digital',
  title: 'Digital',
  hero: { label: 'Services', lines: ['DIGITAL', 'BUILT AROUND', 'YOUR GOALS.'] },
  approach: {
    label: 'Approach',
    paragraphs: [
      'Placeholder: how we approach digital. We start with your goals, agree what good looks like and only then decide what to make.',
  ...
  faq: [
    { q: 'Placeholder: what is included in digital?', a: 'Placeholder answer. One or two sentences that answer the question plainly.' },
